	...
	data() {
		return {
			...
			types: [{
					...
					value: "characters",
					icon: "person",
					description: "Укажите здесь всех персонажей, участвующих в вашей истроии, в том числе второстепенных."
				},
				{
					label: "Локации",
					value: "locations",
					icon: "place",
					description: "Места, в которых происходит действие в вашей истории. Локации можно «вкладыввать» друг в друга связывая их, например создать город, в нем район, улицу, здание или отдельную комнату. Вы можете использовать любой уровень детализации и масштаб, какие необходимо, вплоть до нижнего правого ящика письменного стола."
				},
				{
					label: "Организации",
					value: "organizations",
					icon: "groups",
					description: "Здесь указываются «организации» в широком смысле, не только юридическом типа Полиции, но и всевозможные клубы по интересам, тайные общества, ордены и прочие самопровозглашенные объединения людей, имеющих <i>влияние</i> в вашей истории. Это так же могут быть семьи&nbsp;и&nbsp;рода."
				},
				{
					label: "События",
					value: "events",
					icon: "schedule",
					description: "Это основные действия вашего сюжета — встречи между персонажами, а так же, <i>преступления</i>. Логично задать связи с локацией, где произошло событие, а так же с персонажами, которые в нём участвовали и предметами, которые были использованы."
				},
				{
					label: "Предметы",
					value: "items",
					icon: "build",
					description: "Это могут быть <i>орудия</i> преступления, а так же <i>улики</i>, письма, и любые другие материальные вещи, связанные с вашим сюжетом. Предметы логично связывать с событиями, в которых они участвовали, а так же с их <i>владельцами</i>, а так же с локациями, где они были обнаружены."
				},
				{
					label: "Понятия",
					value: "concepts",
					icon: "psychology",
					description: "В этом разделе удобно указывать такие нематериальные понятия, как «<i>алиби</i>» и «<i>мотивы</i>», которые объясняют поведение ваших персонажей, а так же какие-то их характеристики, особенности, опыт и пристрастия, например наличие медицинского образования, то, что человек является левшой, хромает на правую ногу или хранит чью-то <i>тайну</i>."
				},
			],
			readmode: false,
		}
