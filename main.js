	...
	data() {
		return {
			...
			types: [{
					...
					value: "characters",
					icon: "person",
					description: "Укажите здесь всех персонажей, участвующих в вашей истроии, в том числе второстепенных. Затем свяжите их друг с другом по принципу родства, дружбы или иной близости. Другие виды связей, такие как профессиональные, лучше задавать через связь с <nobr><i><span class='material-icons'>groups</span> организацией</i></nobr>, например один университет или общнее место работы."
				},
				{
					label: "Локации",
					value: "locations",
					icon: "place",
					description: "Места, в которых происходит действие в вашей истории. Локации можно «вкладыввать» друг в друга связывая их, например создать город, в нем район, улицу, здание или отдельную комнату. Вы можете использовать любой уровень детализации и масштаб, какие необходимо, вплоть до нижнего правого ящика письменного стола. Так же логично указать связи с <nobr><i><span class='material-icons'>groups</span> организациями</i></nobr>, если они в этих местах находятся."
				},
				{
					label: "Организации",
					value: "organizations",
					icon: "groups",
					description: "Здесь указываются «организации» в широком смысле, не только юридическом типа Полиции, но и всевозможные клубы по интересам, тайные общества, ордены и прочие самопровозглашенные объединения людей, имеющих <i>влияние</i> в вашей истории. Это так-же могут быть семьи, рода, братства, сестринства и прочие союзы."
				},
				{
					label: "События",
					value: "events",
					icon: "schedule",
					description: "Это основные действия вашего сюжета — встречи героев, а так-же, <i>преступления</i>. Логично задать связи с <nobr><i><span class='material-icons'>place</span> локацией</i></nobr>, где произошло событие, <nobr><i><span class='material-icons'>person</span> персонажами</i></nobr>, которые в нём участвовали и <nobr><i><span class='material-icons'>build</span> предметами</i></nobr>, которые были использованы."
				},
				{
					label: "Предметы",
					value: "items",
					icon: "build",
					description: "Это могут быть орудия преступления, а так-же улики, письма, и любые другие материальные вещи, важные для сюжета. Предметы логично связывать с <nobr><i><span class='material-icons'>schedule</span> событиями</i></nobr>, в которых они использовалисчь, и с их <nobr><i><span class='material-icons'>person</span> владельцами</i></nobr>."
				},
				{
					label: "Понятия",
					value: "concepts",
					icon: "psychology",
					description: "В этом разделе удобно указывать такие нематериальные понятия, как «<i>алиби</i>» и «<i>мотивы</i>», которые объясняют поведение ваших <nobr><i><span class='material-icons'>person</span> персонажей</i></nobr>, а так-же характеристики, особенности, опыт, знания, пристрастия и интересы, например наличие медицинского образования, то, что человек является левшой, хранит чью-то тайну или увлекается коллекционированием марок."
				},
			],
			readmode: false,
		}
